...
from persona.prompt_template.gpt_structure import safe_generate_response_chatgpt
...
def run_gpt_prompt_wake_up_hour(persona, test_input=None, verbose=False): 
  ...
  output = safe_generate_response_chatgpt(prompt, max_tokens=gpt_param.get("max_tokens", 50), temperature=gpt_param.get("temperature", 0.5), repeat=5, fail_safe_response=fail_safe, func_validate=__func_validate, func_clean_up=__func_clean_up)
...
def run_gpt_prompt_daily_plan(persona, 
  ...
  output = safe_generate_response_chatgpt(prompt, 
                                          max_tokens=500,
                                          temperature=1,
                                          repeat=5, 
...
def run_gpt_prompt_task_decomp(persona, 
  ...
  print ("?????")
  print (prompt)
  output = safe_generate_response_chatgpt(prompt, max_tokens=gpt_param.get("max_tokens", 50), temperature=gpt_param.get("temperature", 0.5), repeat=5, fail_safe_response=get_fail_safe(), func_validate=__func_validate, func_clean_up=__func_clean_up)
